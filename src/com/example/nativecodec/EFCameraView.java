...
public final class EFCameraView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback{
	...
	public int 							TYPE_BACK = 1;
	public int 							TYPE_FRONT = 2;
...
//		params.setPreviewFrameRate(25);
		params.setPreviewFpsRange(7*1000, 10*1000); 
		params.setPreviewFrameRate(8);
...
//			this.previewDoing = true ;
	...
	public void surfaceCreated(SurfaceHolder holder) {
		//Log.e("zkzszd","at camera view surfaceCreated");
		// this.prepareCamera() ;
	}
